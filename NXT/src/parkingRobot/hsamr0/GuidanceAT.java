...
//		navigation.ueberpruefenObAktuellInKurve();
		...
		LCD.drawString("KP/Strecke:" + navigation.getAktuellenKurvenpunkt(), 0, 7);
...
//		LCD.drawString("ID: " + navigation.getAktuellstenParkplatz().getID(),0,0);
...
//		LCD.drawString("AnzParkluecken" + navigation.anzahlParkluecken(), 0, 7);
