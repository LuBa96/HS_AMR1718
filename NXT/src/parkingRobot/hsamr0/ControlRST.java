...
public class ControlRST implements IControl {
	...
	public ControlRST(IPerception perception, INavigation navigation,
		...
		// WICHTIG eventuell Übergabe der kalibrierten Werte von Perception für
	...
	private void exec_LINECTRL_ALGO_improved()
	{
		...
		//int soll = weissKali hier müsste die bei der Kalibrierung gemessene Lichtstärke für weiss rein
		int deltae = 0.1*(100-weissKali); //Messunsicherheitsbudget, evtl. abhängig von Lichtverhältnissen; (z.B.: 10% von 100-wertweiss oder so)
