...
public class NavigationAT implements INavigation {
	 ...
	 * aktuelel Kurvenpunkt weiterhin der vorher durchfahrenen Kurve. Fr
	 ...
	 * Matrix stehen für die verschiedenen Sensoren wobei:Encorder (0), Maussensor
...
//	private double frontBoundaryBackSensor = 0;
	...
	private void fusionOfPoseData(double s, double x, double y, double angle) {
		 ...
		 * anschlieüend auf ungefaehr halber Strecke zwischen zwei Ecken zum aktuellen
	 ...
	 * Strecke vor der Kurvenabfahrt abweichen muss. Ob groeüer oder kleiner wurde
